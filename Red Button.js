...
var preloadImage = function(e) {
    ...
    Game = function() {
        function i(t) {
            ...
            if (t.stagesUrl && "localhost" || "logicplays.com" || "games.logicplays.com" === window.location.hostname ? fetch(t.stagesUrl).then(function(t) {
                    return t.json()
                }).then(function(t) {
        ...
        return _createClass(i, [{
            ...
            value: function() {
                ...
                if (t.skip) return this.messageBox.innerHTML = "РљРЅРѕРїРєР° Р±С‹Р»Р° РЅР°Р¶Р°С‚Р° " + this.stage + " СЂР°Р·", void this.stage++;
